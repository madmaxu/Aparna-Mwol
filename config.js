...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By MIDHUN-KALIPPAN' : process.env.ALL_CAPTION,
    ...
    BOT: process.env.BOT_NAME === undefined ? '᭓Aᴘᴀʀɴᴀ Mᴡᴏʟ᭄↹🎀' : process.env.BOT_NAME,
